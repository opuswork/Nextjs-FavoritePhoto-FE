...
export default function Pagination({ currentPage, totalPages, onChange, className = '' }) {
  ...
  return (
    <nav className={`mt-8 md:mt-12 lg:mt-[60px] flex justify-center min-w-0 overflow-x-hidden ${className}`} aria-label="pagination">
      <ul className="flex flex-wrap items-center justify-center gap-2 md:gap-3 lg:gap-[20px]">
        {/* Prev */}
        <li>
          <button
            type="button"
