  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 text-gray-800 leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p>본 약관은 `choicephoto.app`이 제공하는 디지털 사진 생성 플랫폼 서비스의 이용 조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3 text-green-700">제2조 (부적절한 콘텐츠의 관리 및 데이터 처리)</h2>
        <p className="mb-3">1. 본 서비스는 개인의 소중한 디지털 자산을 생성하는 플랫폼으로, 타인의 저작권을 침해하거나 사회적으로 금지된 콘텐츠(음란물, 누드, 폭력물 등)의 거래를 엄격히 금지합니다.</p>
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">1. 사용자가 업로드하거나 생성한 콘텐츠의 저작권 책임은 전적으로 사용자 본인에게 있습니다.</p>
        <p className="mb-2 font-bold text-red-600 underline">2. 불법적 사용으로 인해 서비스 및 제3자에게 손해를 끼친 경우, 해당 사용자는 민·형사상의 모든 법적 책임을 부담하며 수사기관의 조사에 성실히 임해야 합니다.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3 text-green-700">제4조 (준거법 및 재판관할)</h2>
        <p>본 약관과 관련하여 발생하는 모든 분쟁은 대한민국 법령을 준거법으로 하며, 관할 법원은 서비스 제공자의 소재지 관할 법원으로 합니다.</p>
      </section>
